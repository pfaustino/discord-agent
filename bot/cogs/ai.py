...
OWNER_NOTE = (
    ...
    "and cursor_agent_status to check progress. By default commits push directly "
    "to the configured branch (e.g. main) so changes show up without merging "
    "a cursor/ branch. Turn vague requests into "
